...
String reservation_id = AppCubit().getId() as String;
...
String customerDetails = 'reservations/parking-lot/$reservation_id/';
//const customerDetails = 'reservations/parking-lot/${idCustomer}';
String cancelReservation = '/reservations/parking-lot/$reservation_id/cancel';
String activateReservation =
